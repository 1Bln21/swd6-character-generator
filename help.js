...
const HELP_TEXT = {
  ...
  vtt: {
    de: [
      ...
      ['rng_title', 'Klick auf eine Marke, die du bewegen darfst, und die Karte zeigt ihre Reichweiten: Gehen, Laufen und Volle Fahrt in verschiedenen Farben – und dazu, was jede Gangart von der Runde kostet. Volle Fahrt verbraucht sie ganz. Die Waffenreichweite kommt gestrichelt dazu, ein Ring je Abschnitt mit seiner Schwierigkeit. Damit das in Metern stimmt, braucht die Karte einen Maßstab: Am einfachsten trägt die Spielleitung ein, wie breit die Karte insgesamt ist; wer ein Raster eingestellt hat, gibt stattdessen die Meter je Kästchen an. Move und Waffe lassen sich auch an der Marke selbst eintragen - sie gehen dem Bogen vor, was freie Marken abdeckt und Bögen, die noch ohne Move gespeichert wurden. Jeder sieht nur die Reichweiten der Marken, die er auch bewegen darf; die Spielleitung sieht alle.'],
    ...
    en: [
      ...
      ['rng_title', 'Pick a token you may move and the map shows its reach: cruising, high speed and all out in colours of their own, each with what it costs of the round - all out takes the whole of it. The weapon range comes dotted on top, one ring per bracket with its difficulty. For the metres to mean anything the map needs a scale: easiest is its width in metres, or the metres per square where a grid is set. Move and weapon can also be set at the token itself; they come before the sheet, which covers free tokens and sheets saved without a move. Everyone sees the reach of the figures they may move; the GM sees them all.'],
