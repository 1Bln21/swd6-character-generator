...
- **131 Force powers** with prerequisites, difficulties and page references. The Force tab only appears for a Force-sensitive character - by REUP, nobody else can learn Force skills. It stays visible, with a note, if Force dice are already on the sheet, because those still count against the attribute pool
