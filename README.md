...
| **Droids** | `droid.html` — degrees, 167 modifications, 350 ready-made droid templates |
| **Ships & Vehicles** | `ship.html` — 1,255 ship/vehicle templates, modification workshop, weapons, sensors |
...
- **1,255 templates** (932 starships + 323 vehicles) — pick one and every base stat is filled in, weapons included
...
- **Weapon picker**: 892 armament types collected from the ship entries in the compendia, plus the *Galaxy Guide 6* summary with price and weight — filter by scale (Starfighter, Capital, Speeder, Walker, Character), pick one, and every stat is filled in
