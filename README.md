...
- **376 species + 9 near-human variants** with attribute limits, move, special abilities, story factors and page references — 60 from the original workbook plus 316 in a second group — 314 out of the Alien Compendium and two contributed by the community (Rattataki, Pantoran). Both groups are listed alphabetically. Includes Trianii (m/f) and a builder for custom species
...
- **131 Force powers** with prerequisites, difficulties and page references. Each prerequisite links to the power it names - green when learned, highlighted red when not - and a click jumps there. The Force tab only appears for a Force-sensitive character - by REUP, nobody else can learn Force skills. It stays visible, with a note, if Force dice are already on the sheet, because those still count against the attribute pool
...
- **New and used price**, with a choice of which you paid. Where the book names no used price, 45% of the new one is offered as a suggestion - measured across the 324 ships that name both, the median is 47.5%. It stays a suggestion and is never written into the catalogue
- **Modification workshop**: sublight drive, maneuverability, hyperdrive, hull, shields, weapon damage — each with install difficulty, cost as a percentage of the ship, and a growing **mishap modifier**. 359 of the 954 ships carry no price in the books ("Not available for sale"); the workshop says so instead of quietly pricing every refit at zero
...
**Charaktere** (`index.html`) – 26 Charaktervorlagen aus dem Regelwerk (Brash Pilot, Schmuggler, Wookiee, Failed Jedi …): auswählen, übernehmen, losspielen – die 18D Attribute stehen dann wie im Buch, die 7D Fertigkeitswürfel bleiben beim Spieler. Dazu 376 Spezies (60 aus der Excel, 314 weitere aus dem Alien Compendium und zwei aus der Gemeinschaft, im Dropdown getrennt und jeweils alphabetisch aufgeführt) + 9 Near-Human-Varianten, regelkonforme Erschaffung (18D Attribute, 7D Fertigkeiten, Machtfertigkeiten aus dem Attributs-Pool, Steigerung per Charakterpunkten), alle 90 Fertigkeiten samt 20 erweiterten („(A)"), 131 Machtkräfte (der Reiter „Die Macht" erscheint nur bei macht-sensitiven Charakteren; jede Voraussetzung ist ein Link zur genannten Kraft – grün, wenn gelernt, rot hervorgehoben, wenn nicht), Lichtschwert-Werkstatt. **Eigene Spezies lassen sich online speichern** und stehen dann der ganzen Gruppe im Dropdown zur Verfügung.
...
**Schiffe & Fahrzeuge** (`ship.html`) – **1.296 Vorlagen** (954 Raumschiffe + 342 Fahrzeuge): auswählen und alle Grundwerte samt Bewaffnung sind gefüllt. Preis **neu und gebraucht** mit Auswahl, was man bezahlt hat; wo das Buch keinen Gebrauchtpreis nennt, werden 45 % des Neupreises vorgeschlagen. Dazu die Umbau-Werkstatt (Antrieb, Manövrierfähigkeit, Hyperantrieb, Hülle, Schilde, Waffenschaden) mit Einbau-Schwierigkeit, Kosten in Prozent des Schiffswerts und steigendem **Pannen-Modifikator** (bei den 359 Schiffen ohne Preisangabe sagt die Werkstatt das, statt jeden Umbau still mit null zu berechnen), Ersatzteile, bis zu zwölf Waffen, Sensoren und Crew-Skills. Die Bewaffnung lässt sich aus einem **Waffen-Katalog** übernehmen: 1.064 Typen aus den Schiffsbeschreibungen der Sammelbände plus die Übersicht aus *Galaxy Guide 6* mit Preis und Gewicht, filterbar nach Größenklasse. Dazu die **Werkstatt** mit den erweiterten Regeln aus *Galaxy Guide 6: Tramp Freighters*: Pannen auswürfeln für alle fünf Systeme und drei Schweregrade, Reparaturkosten-Tabelle auf den eigenen Schiffswert gerechnet, Raumhafen-Klassen mit Liegegebühren, Vorratsformel, Überholungskosten, Einbauzeiten und die Regeln für gekoppelte Waffen.
